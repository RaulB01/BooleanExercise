...
public class Assignment1 {
	public static void main(String [] args) {
		...
		remaining = sentence.substring (i + 1, sentence.length()); //takes the rest of the sentence- 
		                                                            //- and puts it in front of first word

		System.out.println("You entered: " + sentence); // shows what you have entered
	
		System.out.println("Let me rephrase your entry:"); 
		
		System.out.println(remaining + " " + text1); //prints out the remaining sentence with first word- 
		                                             //- in the end
	}
